...
%==========================================================================
mode.fileNameLUT='Anders1060-6nmQw318In-Bar10nm_17Dic19TEMPrenF'; % filename for LUT
...
lambdavet=[1045:1:1075]*1e-9;% linspace(830,870,41)*1e-9;
