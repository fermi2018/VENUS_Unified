...
xmol_barr= 1-xB; % givenm data from reference
...
Core=repmat([WW BB],1,NQW-1);
CoreW=repmat([WW],1,NQW);
mesh.sizeTOT=[BBoxSide Core WW BBoxSide]*10^-9;
mesh.well=CoreW*10^-9;
