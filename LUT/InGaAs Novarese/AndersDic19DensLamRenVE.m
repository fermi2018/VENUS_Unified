...
%==========================================================================
mode.fileNameLUT='Anders1060-6nmQw318In-Bar10nm_17Dic19renT'; % filename for LUT
...
% Densityv=[ 0.01 5 10]*1e12;
 ...
 Densityv=[.01 1 2 3 4 5];
  ...
  Densityv=linspace(0.5,5,16); % for PL plot
  %Densityv=Densityv(end-4:end-1);
  %Densityv=Densityv(1):.05:Densityv(end);
  %Densityv(1)=1e-4;
 Densityv=Densityv*1e12;
...
lambdavet=[1055]*1e-9;% linspace(830,870,41)*1e-9;
