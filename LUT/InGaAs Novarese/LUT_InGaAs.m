...
%==========================================================================
mode.fileNameLUT='LUT1QW-Bar6nm_5Jul19'; % filename for LUT
...
% Densityv=[ 0.01 5 10]*1e12;
 ...
 Densityv=linspace(0,6,21); % for PL plot
...
lambdavet=[850:1:1000]*1e-9;% linspace(830,870,41)*1e-9;
%==========================================================================
%
%
%
