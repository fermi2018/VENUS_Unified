...
%==========================================================================
mode.fileNameLUT='LUT-BB10_Jun19'; % filename for LUT
...
lambdavet=linspace(1040,1080,41)*1e-9;

Tvet=[290:30:500];

Densityv=[1e-5 1e-4 1e-3 0.01 0.1  0.3:.3:3 4:12]*1e12;
lambdavet=linspace(1000,1150,101)*1e-9;

%lambdavet=linspace(1000,1100,3)*1e-9;
...
if(exist(mesh.fileName,'file'))
    ...
    [Ban,mesh]=f_ComputeQWSubbandsNEW(mesh,mode,Qw_sel);
end
%==========================================================================
% Loading constants
%==========================================================================
...
figure, plot(lambdavet*1e9,squeeze(G(1,1,:))), pausak
