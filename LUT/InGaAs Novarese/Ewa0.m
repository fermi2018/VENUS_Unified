...
%==========================================================================
mode.fileNameLUT='Anders1060-6nmQw318In-Bar10nm_17Dic19renF'; % filename for LUT
 ...
 subplot(122)
  plot(lambda,squeeze(G(:,:,1)))
   xlabel('Wavelenght nm')
    ...
    BD=hcel./EFsplit;
    plot(diag(BD),zeros(size(diag(EFsplit))),'o')
    xlim([min(BD) lambda(end)])
