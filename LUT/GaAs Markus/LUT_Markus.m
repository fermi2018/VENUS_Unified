...
mesh.Lz=6.0e-9; % quantum well width, m
mesh.xmol_barrier=0.30; % Al molar fraction (barrier)
...
%==========================================================================
mode.fileNameLUT='LUT4D_May_Johan_nMark_40'; % filename for LUT
...
Tvet=[290 307 330];
Densityv=[0.0001]*1e12;
lambdavet=[750:.2:860]*1e-9;% linspace(830,870,41)*1e-9;
%==========================================================================
%
%
%
...
Es=squeeze(Es);
ES=Es*diag(1./max(Es));
save Janoptics ES lambdavet


figure, plot(lambdavet*1e9,ES,'linewidth',1.5)
hold on
load PL
plot(PL(:,1),PL(:,2),'ko')
ylabel('PL, arb.un.')
