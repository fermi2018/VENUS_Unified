function [Efn2D]=invferdr_n2D_0(n2D,Em,Ec0,Nc2D,Vt,LowerBound,UpperBound)
%
...
while(max(abs(Efn2D_GuessForNewton-GuessPreviousStep))>tolBisection)
    ...
    [n2D_UB,dum] = ferdr2D_0(xnum,xden);
    ...
    [n2D_LB,dum] = ferdr2D_0(xnum,xden);
