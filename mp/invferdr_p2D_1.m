function [Efp2D]=invferdr_p2D_1(p2D,Ed,Ev0,Nv2D,Vt,LowerBound,UpperBound)
%
...
while(max(abs(Efp2D_GuessForNewton-GuessPreviousStep))>tolBisection)
    ...
    [p2D_UB,dum] = ferdr2D_1(xnum,xden);
    ...
    [p2D_LB,dum] = ferdr2D_1(xnum,xden);
