...
global del_n_agInf
 ...
 if ianti_gui==1
  ...
  %ra_centrale=niat(1)+del_n_agInf*NQW*fatqw;
  ra_centrale=niat(1)+del_n_agInf*NQW_eq;
 end 
%  'qui anti', keyboard
  ...
  pI=ck*(dea*Idelta+deltany*Ideltaa/4);  % fattore 4 per la normalizzazione
    ...
    if ianti_gui==1
     if ~exist('KA_ag')
      ...
      del_eps_ag=2*real(ra)*del_n_ag*NQW_eq/rr^2  ;   %concentro il delta_n nel QW centrale
