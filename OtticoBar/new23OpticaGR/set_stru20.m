...
%'qui cont', keyboard
     pimra=imag(niat(1));
     if isfield(Ps,'losAct')
      pimra=pimra*Ps.losAct;
     end
     ra=real(rqw)+j*pimra*NQW*fatqw;
     cconv=2*k0cm*real(ra);
     g0=pimra*cconv*NQW*fatqw;
   end
   niat(1)=ra;
