function [ga,la,zet,Ez,nz,Gaqw,NQW_ef,az,uL,E_Temp,z_Temp]=fiezCMMn(lam0,L_i,n_i1,iat,icav,fiQW,ifp,dlam,NPlam,rr,kt,ibast,par_grat,a_i);
...
lav=lam0+linspace(-2,2,NPlam)*dlam*lam0;
