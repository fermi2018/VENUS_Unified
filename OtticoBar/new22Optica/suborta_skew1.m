...
for indlambda=1:passo:Nlambda
    ...
    for ind=1:Nstratper
        ...
        [kzG_TE2,kTG_TE2,ZG_TE,kzG_TM2,kTG_TM2,ZG_TM, M1, M2,VTE1loc, VTE2loc, VTE1Hloc, VTE2Hloc, ITE1loc, ITE2loc, ITE1Hloc, ITE2Hloc ,...
            ...
            ModiPeriodLeg_s1(n1(ind),n2(ind),d1,d2,n3,kx,ky,lambda,Nmodi,errorekz);
        ...
        if ind==1 % giunzione semispazio-1^Periodo
            ...
            [TeLR,ThRL] = MatProiezPerUnifAnalitSkewLeft(phi,csi,ky,n1(1),d1,n2(1),d2,VTE1(:,:,ind), VTE2(:,:,ind), VTE1H(:,:,ind), VTE2H(:,:,ind),...
                ...
                ITM1H(:,:,ind), ITM2H(:,:,ind),kz(Nmodi+1:NmodiTETM,ind+1),ZG_TM);
    ...
    [TeGF, ThFG] = MatProiezPerUnifAnalitSkewRight(phi,csi,ky,n1(Nstratper),d1,n2(Nstratper),d2,VTE1(:,:,Nstratper), VTE2(:,:,Nstratper),...
        ...
        ITM1H(:,:,Nstratper), ITM2H(:,:,Nstratper),kz(Nmodi+1:NmodiTETM,Nstratper+1),ZG_TM);
    ...
    if strcmp(flagPlot,'Plot_SI')
        ...
        [eFloqTExAn, eFloqTEyAn, hFloqTExAn, hFloqTEyAn] = FloqzAnComp(x1, d1, x2, d2,phi,csi, ky, k0, n3, 'TE');
        [eFloqTMxAn, eFloqTMyAn, hFloqTMxAn, hFloqTMyAn] = FloqzAnComp(x1, d1, x2, d2,phi,csi, ky, k0, n3, 'TM');
        ...
        for ind=1:Nstratper+1 % ciclo sulle interfacce per verificare la continuita'
            ...
            if ind==1
                ...
                [hfunTEx, hfunTEy, efunTEx, efunTEy] = modefunComp_s(x1, d1, n1(ind), x2, d2, n2(ind), VTE1(:,:,ind), VTE2(:,:,ind),...
                    ITE1(:,:,ind), ITE2(:,:,ind),...
                    kzG_TE2, kTG_TE2, ky, k0, polariz, Clight);
                polariz='TM';
                kzG_TM2=kz(Nmodi+1:NmodiTETM,ind+1).^2;
                kTG_TM2=kT2(Nmodi+1:NmodiTETM,ind+1);
                [hfunTMx, hfunTMy, efunTMx, efunTMy] = modefunComp_s(x1, d1, n1(ind), x2, d2, n2(ind), ITM1(:,:,ind), ITM2(:,:,ind),...
                    VTM1(:,:,ind), VTM2(:,:,ind),...
