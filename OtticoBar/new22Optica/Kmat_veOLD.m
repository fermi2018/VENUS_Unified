...
%'qui Sit', keyboard
   if igraef_new>=0 & ifalso==-1  %caso anisotropia
...
%    smu=1; snu=1;
    KEEd=(Kpp*Sig_eps+pol*Imm*Del_eps);
    KEMd=(Kpm*Sig_eps+pol*Imm*Del_eps);
    M13=Del_eps*Imp;
    M31=Del_eps*Ipm;
    KEEp=(diae*(KEEd+M31+M13)*diae1);
    KEMp=(diae*(KEMd+M31-M13)*diam1);
    KMEp=(diam*(KEMd-M31+M13)*diae1);
    KMMp=(diam*(KEEd-M31-M13)*diam1);    
